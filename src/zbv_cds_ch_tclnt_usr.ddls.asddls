@AbapCatalog.sqlViewName: 'ZCCHTCLNT_USR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Monitorar chamados em Teste Cliente - Consultor'
@Metadata.ignorePropagatedAnnotations: true
@OData.publish: true
define view ZBV_CDS_CH_TCLNT_USR
...
} where chamados.status = 'Teste Cliente'
