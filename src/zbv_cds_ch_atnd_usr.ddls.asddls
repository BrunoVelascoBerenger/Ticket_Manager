@AbapCatalog.sqlViewName: 'ZCCHATND_USR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Monitorar chamados em Atendimento - Consultor'
@Metadata.ignorePropagatedAnnotations: true
@OData.publish: true
define view ZBV_CDS_CH_ATND_USR
...
where
  ...
  or chamados.status = 'Desenvolvimento'
