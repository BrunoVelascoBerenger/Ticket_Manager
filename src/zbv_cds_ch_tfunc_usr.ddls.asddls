@AbapCatalog.sqlViewName: 'ZCCHTFUNC_USR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Monitorar chamados em Teste Funcional - Consultor'
@Metadata.ignorePropagatedAnnotations: true
@OData.publish: true
define view ZBV_CDS_CH_TFUNC_USR
...
where
  chamados.status = 'Teste Funcional'
